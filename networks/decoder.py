...
class Decoder(nn.Module):
    def __init__(self, encoder_model):
        ...
        self.upsample1 = Upsample(
            num_features + channels[0], num_features // 2)
        self.upsample2 = Upsample(
            num_features // 2 + channels[1], num_features // 4)
        self.upsample3 = Upsample(
            num_features // 4 + channels[2], num_features // 8)
        self.upsample4 = Upsample(
            num_features // 8 + channels[3], num_features // 16)
        self.upsample5 = Upsample(
            num_features // 16 + channels[4], num_features // 32)

        self.conv3 = nn.Conv2d(num_features // 32, 1,
